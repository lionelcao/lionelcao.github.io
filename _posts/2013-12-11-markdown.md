...
description: ""
category: "syntax"
tags: [reprints, markdown, github, syntax, html]
---
{% include JB/setup %}
...
Markdown 的目标是实现「易读易写」。[点击查看快速入门](http://wowubuntu.com/markdown/basic.html)
...
(注：本文转载自[Wow!Ubuntu](http://wowubuntu.com/markdown/),部分格式稍有修改。)
